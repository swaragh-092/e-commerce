...
const { idParamSchema, idAndAttrIdParamSchema, uuidCsvParamSchema } = require('../../utils/common.validation');
...
router.get('/:id/attributes', ...categoryAttributeRead, validate(uuidCsvParamSchema, 'params'), controller.getCategoryAttributes);
