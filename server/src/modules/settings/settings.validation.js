...
const updateSettingsGroupSchema = Joi.object({
  group: Joi.string().valid('theme', 'features', 'payments', 'sales', 'seo', 'general', 'shipping', 'tax', 'sku', 'logo', 'hero', 'auth', 'footer', 'announcement', 'nav', 'catalog', 'homepage', 'productPage', 'brandsPage', 'admin', 'invoice', 'gateway_credentials', 'messaging', 'messaging_credentials', 'advanced').required(),
