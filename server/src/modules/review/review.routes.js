...
router.put('/admin/reviews/:id/moderate', authenticate, authorize('admin', 'super_admin'), validate(moderateReviewSchema), reviewController.moderate);

// Admin delete reviews
router.delete('/admin/reviews/:id', authenticate, authorize('admin', 'super_admin'), reviewController.remove);
