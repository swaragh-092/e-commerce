...
const ProductImages = ({ images }) => {
    ...
    return (
        <Box>
            <Box sx={{ width: '100%', pt: '100%', position: 'relative', mb: 2, backgroundColor: '#f5f5f5', borderRadius: 1, overflow: 'hidden' }}>
                <CardMedia
                    component="img"
                    image={selectedImage}
                        ...
                        <Grid item xs={3} sm={2} md={3} key={img.id}>
                            <Box 
                                ...
                                sx={{ 
                                    ...
                                    position: 'relative', 
                                    cursor: 'pointer',
                                    border: selectedImage === img.url ? '2px solid #1976d2' : '1px solid transparent',
                                    borderRadius: 1,
                                    overflow: 'hidden',
